      ...
      <section className="glass-panel rounded-[30px] border border-white/10 p-6 sm:p-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-black tracking-tight text-white">Edit pizza details</h1>
          </div>
      ...
      <section className="glass-panel rounded-[30px] border border-white/10 p-6 sm:p-8">
        <div className="grid gap-6 md:grid-cols-2">
          <label className="space-y-2 text-sm text-white/70 md:col-span-2">
            ...
            <input defaultValue="Truffle Mushroom" className="w-full rounded-2xl border border-white/10 bg-[#1a120f] px-4 py-3 text-white outline-none" />
          </label>

          <label className="space-y-2 text-sm text-white/70">
            <span>Price</span>
            <input defaultValue="$22" className="w-full rounded-2xl border border-white/10 bg-[#1a120f] px-4 py-3 text-white outline-none" />
          </label>
          ...
          <label className="space-y-2 text-sm text-white/70 md:col-span-2">
            ...
            <textarea rows={5} defaultValue="Rich roast mushroom flavor, crème fraîche, parmesan, combined with truffle oil for a deep savory finish." className="w-full rounded-2xl border border-white/10 bg-[#1a120f] px-4 py-3 text-white outline-none" />
          </label>
        </div>
